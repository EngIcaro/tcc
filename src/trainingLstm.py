...
for j in range(1,9):
    ...
    joblib.dump(normalizador, r'./../saidas/normTrainingInput'+layer1+layer2+'['+str(fold)+'].save')
    ...
    joblib.dump(normalizador_output, r'./../saidas/normTrainingOutput'+layer1+layer2+'['+str(fold)+'].save')
    ...
    for i in range(20, (np.size(base_teste_normalizada[:,0])-5)):
        ...
        saidas_teste.append(base_teste_output_treinamento_norm[i,0])
    ...
    mcp =  ModelCheckpoint(filepath=r'./../saidas/pesos_lstm'+layer1+layer2+'['+str(fold)+'].h5', monitor = 'loss', save_best_only= True)
    ...
    with open(r'./../saidas/history_lstm'+layer1+layer2+'['+str(fold)+']', 'w') as json_file:
        json_file.write(j_hist)
    #j_hist = json.dumps(hist)
    with open(r'./../saidas/regressor_lstm'+layer1+layer2+'['+str(fold)+'].json', 'w') as json_file:
